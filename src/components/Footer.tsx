    ...
    <footer className="bg-black text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-semibold mb-6">About QuickCart</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/shop" className="text-gray-400 hover:text-white text-sm">Shop</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white text-sm">Size Guide</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              Quick Cart © 2000-2023. All Rights Reserved
            </p>
